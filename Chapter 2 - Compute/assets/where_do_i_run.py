...
# Runs in the Driver Program to open a session (a spark context)
...
# Wide transformation, evaluated lazily in the driver program
...
# Actions which executed in the worker nodes by spark executors
